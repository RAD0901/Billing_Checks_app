...
class BillingCheckToolGUI:
    def __init__(self, master):
        ...
        tk.Label(master, text="Select Prior Month CSV:", fg="#2457FC").grid(row=1, column=0, padx=10, pady=5)
        self.entry_prior = tk.Entry(master, width=50)
        self.entry_prior.grid(row=1, column=1, padx=10, pady=5)
        tk.Button(master, text="Browse", command=self.browse_prior_csv).grid(row=1, column=2, padx=10, pady=5)

        tk.Label(master, text="Select Current Month CSV:", fg="#2457FC").grid(row=2, column=0, padx=10, pady=5)
        self.entry_current = tk.Entry(master, width=50)
        self.entry_current.grid(row=2, column=1, padx=10, pady=5)
        tk.Button(master, text="Browse", command=self.browse_current_csv).grid(row=2, column=2, padx=10, pady=5)

        tk.Label(master, text="Select Sales CSV:", fg="#2457FC").grid(row=3, column=0, padx=10, pady=5)
        self.entry_sales = tk.Entry(master, width=50)
        self.entry_sales.grid(row=3, column=1, padx=10, pady=5)
        tk.Button(master, text="Browse", command=self.browse_sales_csv).grid(row=3, column=2, padx=10, pady=5)

        tk.Label(master, text="Select Delayed Billing Client List CSV:", fg="#2457FC").grid(row=4, column=0, padx=10, pady=5)
        self.entry_delayed = tk.Entry(master, width=50)
        self.entry_delayed.grid(row=4, column=1, padx=10, pady=5)
        tk.Button(master, text="Browse", command=self.browse_delayed_csv).grid(row=4, column=2, padx=10, pady=5)

        tk.Label(master, text="Select Client Device Report CSV:", fg="#2457FC").grid(row=5, column=0, padx=10, pady=5)
        self.entry_client_device = tk.Entry(master, width=50)
        self.entry_client_device.grid(row=5, column=1, padx=10, pady=5)
        tk.Button(master, text="Browse", command=self.browse_client_device_csv).grid(row=5, column=2, padx=10, pady=5)

        tk.Label(master, text="Select Month:", fg="#2457FC").grid(row=6, column=0, padx=10, pady=5)
        ...
        self.month_dropdown.grid(row=6, column=1, padx=10, pady=5, sticky="w")

        tk.Label(master, text="Select Year:", fg="#2457FC").grid(row=7, column=0, padx=10, pady=5)
        ...
        self.year_dropdown.grid(row=7, column=1, padx=10, pady=5, sticky="w")

        tk.Label(master, text="Save Processed File As:", fg="#2457FC").grid(row=8, column=0, padx=10, pady=5)
        self.entry_save = tk.Entry(master, width=50)
        self.entry_save.grid(row=8, column=1, padx=10, pady=5)
        tk.Button(master, text="Browse", command=self.browse_save_path).grid(row=8, column=2, padx=10, pady=5)

        tk.Button(master, text="Process", command=self.process, width=20, bg="#2457FC", fg="#FFFFFF").grid(row=9, column=0, columnspan=3, padx=10, pady=20)
        ...
        self.progress_bar = customtkinter.CTkProgressBar(master, orientation="horizontal",
                                                          ...
                                                          border_color="#F2F2F2",
                                                          fg_color="#DEDEDE",
                                                          progress_color="#0336DB")
        self.progress_bar.grid(row=10, column=0, columnspan=3, pady=10, padx=10)
